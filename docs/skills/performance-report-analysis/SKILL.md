...
license: MIT
compatibility: "OpenAI, Codex, ChatGPT Projects, Claude Code, Cursor, Windsurf. Tool-agnostic: works with output from k6, Gatling, Locust, JMeter, Artillery, and custom tools."
model: generic
metadata:
  author: rcampos
  version: "1.2"
