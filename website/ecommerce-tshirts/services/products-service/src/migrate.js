...
async function runMigrations() {
  ...
  try {
    ...
    if (parseInt(catRows[0].count) === 0) {
      ...
      `);
      console.log('[migrate] products-service: seed de categorías insertado');
    }
    ...
    if (parseInt(prodRows[0].count) === 0) {
      ...
      `);
      console.log('[migrate] products-service: seed de productos insertado');
      ...
      `);
      console.log('[migrate] products-service: seed de variantes insertado');
    }

    console.log('[migrate] products-service: tablas verificadas/creadas correctamente');
  } finally {
    client.release();
  }
}
